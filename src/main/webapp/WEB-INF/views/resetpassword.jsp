...
<body>
    <div class="reset-container">
        <!-- Top banner image -->
        <img src="${pageContext.request.contextPath}/resources/images/resetpassword.png" alt="Bank Logo">

        <h2>Reset Password</h2>
        <form action="${pageContext.request.contextPath}/customer/resetpassword" method="post">
